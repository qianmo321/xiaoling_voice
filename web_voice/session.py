...
WAKE_WORDS = [
    ...
    "シャオリン", "しゃおりん",
    "シャオリング", "シャーリン", "シャオリーン",
    "こんにちは", "こんにちわ",   # 通用打招呼词（保留：打招呼即唤醒更自然；代价是旁人打招呼会误唤醒）
    "こんにちはシャオリン",
    "ハロー",
    "すみません",
    "你好",   # 同上
...
_STANDBY_MESSAGES = {
    ...
    "日语": "しばらくお声が聞こえなかったので、待機モードに入りますね。ご用の際は『こんにちはシャオリン』と呼んでください。",
}

_TRANSCRIBE_PROMPTS = {
    # 只声明语言，其它一律不写！写"名字叫小灵"→模糊人声被脑补成唤醒词(误唤醒)；
    # 写"导览/介绍"→杂音被脑补成客服套话("你好请问需要帮助吗")。都踩过坑。
    # 真喊"小灵"被听成"小玲/小凌"没关系——唤醒词表收了全套同音字。
    "中文": "以下是中文普通话对话。",
    "日语": "以下は日本語の会話です。",
}
